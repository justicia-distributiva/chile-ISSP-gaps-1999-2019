...
salario_per
 ggsave(salario_per,filename = "images/salario_per.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")
...
```{r Tablas descriptivos ln(gaps), eval=FALSE, include=FALSE}
# Tabla 1 ****************************************************************************************
...
# Subjective Social Status and Salary Gaps
...
## Subjective status and percieved salary gap

```{r scatter ess-lnperc, results='hold',eval=FALSE}
#--- Year 1999---------------------------------------------------------------#
essplot <- ggplot(data = subset(clw3,year==1999), aes(ess)) +
  geom_histogram(alpha=0.4,binwidth = 0.5) +
   theme_transparent() 
essplot <- ggplotGrob(essplot)
...
plot01a + annotation_custom(grob = essplot, xmin = 0, xmax = 10,ymin = 0.9162907, ymax = 10)
plot01a
ggsave(plot01a,filename = "images/ess_lnperc99.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")
#--- Year 2009---------------------------------------------------------------#

essplot2 <- ggplot(data = subset(clw3,year==2009), aes(ess)) + geom_bar(alpha=0.4,binwidth = 0.5) + theme_transparent()
essplot2 <- ggplotGrob(essplot2)
...
plot01b<-ggplot(data=subset(clw3,year==2009), aes(ess, y=lngap_perc)) +
  ...
  theme_classic(base_size = 17) +
      theme(axis.text=element_text(size=10,face = "plain"),
         ...
         panel.grid = element_blank(),
         panel.border = element_blank())
plot01b <- plot01b + annotation_custom(grob = essplot2)
plot01b
ggsave(plot01b,filename = "images/ess_lnperc09.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")

#--- Year 2019---------------------------------------------------------------#

essplot3 <- ggplot(data = subset(clw3,year==2019), aes(ess)) + geom_histogram(alpha=0.4,binwidth = 0.5) + theme_transparent()
essplot3 <- ggplotGrob(essplot3)
...
plot01c<-ggplot(data=subset(clw3,year==2019), aes(ess, y=lngap_perc)) +
  ...
  theme_classic(base_size = 17) +
      theme(axis.text=element_text(size=10,face = "plain"),
         ...
         panel.grid = element_blank(),
         panel.border = element_blank())
plot01c <- plot01c + annotation_custom(grob = essplot3)
plot01c
ggsave(plot01c,filename = "images/ess_lnperc19.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")

#--- Year 1999 to 2019---------------------------------------------------------------#

essplot4 <- ggplot(data = clw3, aes(ess)) + geom_histogram(alpha=0.4,binwidth = 0.5) + theme_transparent()
essplot4 <- ggplotGrob(essplot4)
...
plot01d<-ggplot(data=clw3, aes(ess, y=lngap_perc)) +
  ...
  theme_classic(base_size = 17) +
   theme(axis.text=element_text(size=10,face = "plain"),
         ...
         panel.grid = element_blank(),
         panel.border = element_blank())
plot01d <- plot01d  + annotation_custom(grob = essplot4,xmin = 0.03,xmax = 10.9,ymin = -1.9)
plot01d
ggsave(plot01d,filename = "images/ess_lnperc99_19.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")
```

## Subjective status and just salary gap

```{r scatter ess-lnjust, eval=FALSE}
#--- Year 1999---------------------------------------------------------------#
plot02a <- ggplot(data=subset(clw3,year==1999), aes(ess, y=lngap_just)) +
  ...
  theme_classic(base_size = 17) +
      theme(axis.text=element_text(size=10,face = "plain"),
         ...
         panel.border = element_blank())
plot02a
ggsave(plot02a,filename = "images/ess_lnjust99.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")
#--- Year 2009---------------------------------------------------------------#
plot02b <- ggplot(data=subset(clw3,year==2009), aes(ess, y=lngap_just)) +
  ...
  theme_classic(base_size = 17) +
        theme(axis.text=element_text(size=10,face = "plain"),
         ...
         panel.border = element_blank())
plot02b
ggsave(plot02b,filename = "images/ess_lnjust09.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")
#--- Year 2019---------------------------------------------------------------#
plot02c <- ggplot(data=subset(clw3,year==2019), aes(ess, y=lngap_just)) +
  ...
  theme_classic(base_size = 17) +
      theme(axis.text=element_text(size=10,face = "plain"),
         ...
         panel.border = element_blank())
plot02c
ggsave(plot02c,filename = "images/ess_lnjust19.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")
#--- Year 1999-2019---------------------------------------------------------------#
...
plot02d <- ggplot(data=clw3, aes(ess, y=lngap_just)) +
  ...
  theme_classic(base_size = 17) +
      theme(axis.text=element_text(size=10,face = "plain"),
         ...
         panel.grid = element_blank(),
         panel.border = element_blank())
plot02d <- plot02d + annotation_custom(grob = essplot4,xmin = 0.03,xmax = 10.9,ymin = -5.5)
ggsave(plot02d,filename = "images/ess_lnjust99_19.png",device = "png",width = 20,height = 15,dpi = "retina",units = "cm")
```
