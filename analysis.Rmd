...
table_ed_gapper$ocup2 <- factor(table_ed_gapper$Educacion, levels=c(1,2,3,4), labels=c("Basica o menos", "Media completa", "Tecnico completa" , "Univercitario o más"))
...
table_ed_gapper
 ...
 ggsave(table_ed_gapper,filename = "images/salario_per.png",device = "png",width = 30,height = 15,dpi = "retina",units = "cm")
...
table_ed_gapjus$ocup2 <- factor(table_ed_gapjus$Educacion, levels=c(1,2,3,4), labels=c("Basica o menos", "Media completa", "Tecnico completa" , "Univercitario o más"))
...
table_ed_gapjus
 ...
 ggsave(table_ed_gapjus,filename = "images/salario_per.png",device = "png",width = 30,height = 15,dpi = "retina",units = "cm")
```
