...
- Hacer un par de boxplot para cada variable de Obrero Gerente (hacer pull luego de esto).
- CASEN (2009,2011,2013,2015,2017): Cálculo de los salarios por ocupación (media y mediana).
    - Emplear diseño muestral complejo
...
sal <- rbind(sal99,sal09,sal19)
sal$year <- as.factor(sal$year)
```

## Boxplot salario percibido

```{r boxplot salario percibido obrero}
boxplot(salperobr~year,data=sal,horizontal=TRUE,
        main="Salario percibido Obrero (outliers visualizados)")
boxplot(salperobr~year,data=sal, horizontal=TRUE, outline=FALSE,
        main="Salario percibido Obrero (outliers no visualizados)")
```

```{r boxplot salario percibido gerente}
boxplot(salperger~year,data=sal,horizontal=TRUE,
        main="Salario percibido Gerente (outliers visualizados)")
boxplot(salperger~year,data=sal,horizontal=TRUE, outline=FALSE,
        main="Salario percibido Gerente (outliers no visualizados)")
```

```{r boxplot gap salario percibido}
boxplot(gap_perc~year,data=sal,horizontal=TRUE,
        main="Brecha Salario percibido (outliers visualizados)")
boxplot(gap_perc~year,data=sal,horizontal=TRUE, outline=FALSE,
        main="Brecha Salario percibido (outliers no visualizados)")
```

## Boxplot salario justo

```{r boxplot salario just obrero}
boxplot(saljusobr~year,data=sal,horizontal=TRUE,
        main="Salario justo Obrero (outliers visualizados)")
boxplot(saljusobr~year,data=sal, horizontal=TRUE, outline=FALSE,
        main="Salario justo Obrero (outliers no visualizados)")
```

```{r boxplot salario justo gerente}
boxplot(saljusger~year,data=sal,horizontal=TRUE,
        main="Salario justo Gerente (outliers visualizados)")
boxplot(saljusger~year,data=sal,horizontal=TRUE, outline=FALSE,
        main="Salario justo Gerente (outliers no visualizados)")
```

```{r boxplot gap salario justo}
boxplot(gap_just~year,data=sal,horizontal=TRUE,
        main="Brecha Salario justo (outliers visualizados)")
boxplot(gap_just~year,data=sal,horizontal=TRUE, outline=FALSE,
        main="Brecha Salario justo (outliers no visualizados)")
```
...
```{r descriptivos brecha total (trimmed) 1999-2019}
# Tabla 3 ****************************************************************************************
